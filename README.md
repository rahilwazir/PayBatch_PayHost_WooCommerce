...
## PayGate PayBatch (with PayHost tokenization) plugin v1.0.0 for WooCommerce v3.9.1
...
## Installation
Please navigate to the [releases page](https://github.com/PayGate/PayBatch_PayHost_WooCommerce/releases), download the latest release (v1.0.0) and unzip. You will them be able to follow the integration guide which is included in the zip.
